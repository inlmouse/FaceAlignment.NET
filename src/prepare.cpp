...
CascadeClassifier cc("C:\\Research\\face-alignment\\model\\haarcascade_frontalface_alt.xml");
...
int prepare(void) {
    ...
    genTxt(txt, params.dataset + "\\train.txt");
    txt = params.dataset + "\\Path_Images_test.txt";
    genTxt(txt, params.dataset + "\\test.txt");
    return 0;
}
